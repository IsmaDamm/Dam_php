        ...
        <div class="container">
            ...
            <form action="resumen.php" method="post">
                <div class="nombre">
                    ...
                    <input type="text" class="form-control" id="nombre" name = "nombre" value = "<?php echo $nombre ?>" readonly aria-describedby="nombreHelp">
                    <div id="nombreHelp" class="form-text"></div>
                </div>
                <div class="apellidos">
                    <label for="apellidos" class="form-label">Apellidos</label>
                    <input type="text" class="form-control" id="apellidos" name = "apellido" aria-describedby="apellidosHelp">
                    <div id="apellidopsHelp" class="form-text"></div>
                </div>
                <div class="nif">
                    <label for="nombre" class="form-label">NIF</label>
                    <input type="text" class="form-control" id="nif" name = "nif" aria-describedby="nifHelp">
                    <div id="nifHelp" class="form-text"></div>
                </div>
                <div class="telefono">
                    <label for="nombre" class="form-label">Telefono</label>
                    <input type="number" class="form-control" id="telefono" name = "tel" aria-describedby="telefonoHelp">
                    <div id="telefonoHelp" class="form-text"></div>
                </div>
                <div class="codigopostal">
                    <label for="codigopostal" class="form-label">Codigo Postal</label>
                    <input type="text" class="form-control" id="nombre"  name = "codi" aria-describedby="codigopostalHelp">
                    <div id="codigopostalHelp" class="form-text"></div>
                </div>
                <div class="poblacion">
                    <label for="poblacion" class="form-label">Poblacion</label>
                    <input type="text" class="form-control" id="poblacion"  name = "pobl" aria-describedby="poblacionHelp">
